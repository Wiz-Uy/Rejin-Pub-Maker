...
function generateImage() {
  ...
  let bg = randomPart("background/", 20);
  setBackground(bg);



  let hat = randomPart("Hat/", 19);
  setHat(hat);

  let eye = randomPart("Eyes/", 7);
  setEyes(eye);

  let mouth = randomPart("Mouth/", 4);
  setMouth(mouth);

 setShirt(randomPart("Clothes/", 9));

   let body = randomPart("Body/", 4);
  setBody(body);
